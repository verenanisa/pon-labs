...
<div class="container my-3">
    <h3 class="mb-3 title-text-bold">Pengajuan Pembuatan Surat Keterangan Tidak Mampu (SKTM)</h3>
    <div class="row">
        <div class="col-lg-3">
            <div class="mb-3">
        ...
        <div class="col-lg-3 mb-3">
            ...
            <label for="inputGroupFile04" class="form-label body-text">Selfie dengan KTP</label>
