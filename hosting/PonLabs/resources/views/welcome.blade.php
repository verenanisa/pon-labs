...
<div class="container mt-5">
    <div class="title-text d-flex justify-content-around  mb-5">Seputar Pondok Labu</div>
    <div class="row">
        <!-- Pengumuman -->
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <a href="/pengumuman" class="ms-auto align-self-center text-reset navbar-text" style="text-decoration:none">Lainnya</a>
                    </div>
                    <div class="row">
                        <!-- Pengumuman 1 -->
                        <div class="col-md-4">
